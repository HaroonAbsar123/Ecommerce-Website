      ...
      >
        ...
        {editing === false ? (
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            {!savingDetails ? 
      <Button variant="contained" color="success" onClick={() => {savingChanges()}}>Save</Button>
:
      <LoadingButton
        loading
      ...
      <div style={{flex: 1}}>
        ...
        {editing === false ? (
          <><span style={{ fontWeight: "bold" }}>Name: </span>{userDetails?.userName ? userDetails?.userName : "N/A"}</>
        ) : (
          <TextField
            label="Name"
            style={{width: '100%'}}
      ...
      <div style={{flex: 1, marginTop: '10px'}}>
        ...
        {editing === false ? (
          <>
           <span style={{ fontWeight: "bold" }}>Apartment / Suite: </span>
