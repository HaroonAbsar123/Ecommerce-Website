    ...
    <div className={classes.mainContainer}>
      <div className={classes.secondContainer}>
        <div style={{ flex: 1, overflow: "auto" }}>
          ...
          <Button
            disabled={cartError || Products?.length < 1}
            variant="contained"
            onClick={handleOpen}
            style={{
              width: "100%",
              marginTop: "10px",
              backgroundColor: (cartError || Products?.length < 1) ? "#ccc" : "#1e1e1e",
              color: "white",
            }}
          >
            PLACE ORDER
          ...
          {cartError && (
            <div style={{ marginTop: "10px", color: "red" }}>
              Please consider making suggested alterations to your cart before
