  ...
  useEffect(() => {
    ...
    for (const category in products) {
      ...
      if (Array.isArray(products[category])) {
        // Check if products[category] is an array
    ...
    <div className={classes.mainContainer}>
      {!isMobile && (
        <div className={classes.firstHalf}>
          <div className={classes.firstHalfContainer}></div>
        </div>
      )}
      <div className={classes.secondHalf}>
        <h1 className={classes.secondHalfTitle}>
          Renovate your interior with moduler design
        </h1>
